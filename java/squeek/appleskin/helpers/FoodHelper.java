...
public class FoodHelper
{
	public static boolean isFood(ItemStack itemStack)
	{
		...
		return itemStack.getComponents().contains(DataComponentTypes.FOOD);
	}
	...
	public static FoodValues getDefaultFoodValues(ItemStack itemStack)
	{
		...
		float saturationModifier = itemFood != null ? itemFood.saturation() : 0;
	...
	public static boolean isRotten(ItemStack itemStack)
	{
		...
		{
			if (effect.effect().getEffectType() != null && effect.effect().getEffectType().value().getCategory() == StatusEffectCategory.HARMFUL)
				return true;
		}
		return false;
	}
